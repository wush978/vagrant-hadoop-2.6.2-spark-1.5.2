...
HADOOP_MIRROR_DOWNLOAD=http://apache.stu.edu.tw/hadoop/common/hadoop-2.6.2/hadoop-2.6.2.tar.gz
...
SPARK_MIRROR_DOWNLOAD=http://apache.stu.edu.tw/spark/spark-1.5.2/spark-1.5.2-bin-hadoop2.6.tgz
